...
namespace i5.VirtualAgents.Speech
{
    public class AzureSpeechRecognizer : MonoBehaviour, ISpeechRecognizer
    {
        ...
        public AzureRecognitionMode Mode { get => mode; set => mode = value; }
        ...
        private async Task<RecognitionResult> StartContinuousRecordingAsync() {
            Debug.Log("Speak into your microphone. Press F5 to stop recording.");
            ...
            switch (speechRecognitionResult.Reason) {
                ...
                case ResultReason.Canceled:
                    ...
                    if (cancellation.Reason == CancellationReason.Error) {
                        result.Message += $" AzureErrorCode={cancellation.ErrorCode}. ErrorDetails = {cancellation.ErrorDetails}.\nDid you set the speech resource key and region values?";
                    }
                    break;
                default:
